window.MINOVA_SITE_CONFIG = Object.freeze({
  // Set this to the deployed server/feedback-service.mjs URL to use Minova's
  // first-party Resend delivery path, for example:
  ...
  latestInstallerUrl: "https://github.com/minova-chromium/Minova-Chromium/releases/download/v1.0.3/Minova-Chromium-Setup-1.0.3.exe",
